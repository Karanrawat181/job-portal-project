             ...
             <td><%= rs.getString("date")%></td>
              <td><%= rs.getString("post_by")%></td>
               <td><%= rs.getString("description")%></td>
                ...
                <td> <a href= 'jobcrud.jsp?u=<%= rs.getString("id") %>' class="btn btn-primary" role="button">Edit</a>
                     <a href= 'jobcruddlt.jsp?v=<%= rs.getString("id") %>' class="btn btn-danger" role="button"> Delete</a>
                </td>
