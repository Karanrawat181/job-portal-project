    ...
    <body>
       <nav class="navbar navbar-expand-lg navbar-inverse navbar-light bg-success">
            ...
            <a href="#"   class="navbar-brand text-dark"> JOBPORTAL </a>
               ...
               <li class="nav-item">
                   <a href="utable.jsp" class="nav-link text-dark" >User List</a>
               </li>
               <li class="nav-item">
...
%>
   ...
   Statement st=con1.createStatement();
    String data="select * from recdata ";
             ...
             <td><%= rs.getString("login_id")%></td>
              <td><%= rs.getString("gender")%></td>
               <td><%= rs.getString("mobileno")%></td>
                ...
                <td> <a href= 'reccrud.jsp?u=<%= rs.getString("id") %>' class="btn btn-primary" role="button">Edit</a>
                     <a href= 'reccruddlt.jsp?v=<%= rs.getString("id") %>' class="btn btn-danger" role="button"> Delete</a>
                </td>
